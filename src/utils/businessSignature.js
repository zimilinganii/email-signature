...
export function businessSignature(p,{preview,accent,background,text,escapeHtml:esc,safeImage}) {
  ...
  const locationHtml=location?`<div data-business-location="address" style="padding-top:8px;max-width:260px;white-space:normal;overflow-wrap:anywhere;word-break:break-word;font-size:12px;line-height:18px;color:${text};">${esc(location)}</div>`:'';
